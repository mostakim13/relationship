...
<body>
    ...
    <form action="{{ route('updateData2',$info->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
            <label for="name" class="form-label">Student ID</label>
            <input type="text" value="{{ $info->student_id }}" class="form-control" id="name1" name="student_id" placeholder="Enter your id">
        ...
        <div class="mb-3">
          ...
          <input type="text" value="{{ $info->Father }}" class="form-control" id="name1" name="father" placeholder="Enter father name">
        </div>
        <div class="mb-3">
            <label for="name" class="form-label">Mother</label>
            <input type="text" value="{{ $info->Mother }}" class="form-control" id="roll1" name="mother" placeholder="Enter mother name">
          </div>
          <div class="mb-3">
            <label for="name" class="form-label">Address</label>
            <input type="text" value="{{ $info->Address }}" class="form-control" id="class1" name="address" placeholder="Enter address">
          </div>
