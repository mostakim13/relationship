        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="{{ url('show') }}">Home <span class="sr-only"></span></a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="{{ url('showData1') }}">Student Info</a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ url('showData2') }}">More details</a>
            </li>
