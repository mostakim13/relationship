...
<body>
    ...
    <form action="{{ route('updateData1',$info->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
          <label for="name" class="form-label">Name</label>
          <input type="text" value="{{ $info->Name }}" class="form-control" id="name1" name="name" placeholder="Enter name">
        </div>
        <div class="mb-3">
            <label for="name" class="form-label">Roll</label>
            <input type="text" value="{{ $info->Roll }}" class="form-control" id="roll1" name="roll" placeholder="Enter roll">
          </div>
          <div class="mb-3">
            <label for="name" class="form-label">Class</label>
            <input type="text" value="{{ $info->Class }}" class="form-control" id="class1" name="class" placeholder="Enter class">
          </div>
          <div class="mb-3">
            <label for="name" class="form-label">Section</label>
            <input type="text" value="{{ $info->Section }}" class="form-control" id="section1" name="section" placeholder="Enter section">
          </div>
          <div class="mb-3">
